...
// Why Library → Prompts can edit a template without restarting the conversation, unlike anything
// baked into the system prompt: pi reads templates from the loader on every prompt, so
// refreshing the loader is enough. If this ever fails, the Library → Prompts copy about immediate
// effect is wrong too.
