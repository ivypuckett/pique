...
// execute until a human reviews and enables it in Settings → Extensions, which moves it
  ...
  return [
    defineTool({
      ...
      description:
        ...
        "user reviews and enables it in Settings → Extensions, and then only in chat sessions " +
